...
export default function Footer() {
  return (
    //FOOTER
    <footer className="bg-navy text-white border-t border-navy-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              <div className="text-gray-300 hover:text-brand">Branding</div>
              <div className="text-gray-300 hover:text-brand">Design</div>
              <div className="text-gray-300 hover:text-brand">Marketing</div>
              <div className="text-gray-300 hover:text-brand">
                Advertisement
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-2">
              <div className="text-gray-300 hover:text-brand">About us</div>
              <div className="text-gray-300 hover:text-brand">Contact</div>
              <div className="text-gray-300 hover:text-brand">Jobs</div>
              <div className="text-gray-300 hover:text-brand">Press kit</div>
            </div>
          </div>
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white mb-4">
